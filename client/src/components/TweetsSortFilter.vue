	...
	<div class="flex flex-col">
		<div class="flex flex-row flex-start items-center">
			<div>
				...
				<div class="my-2" />
				<VueDatePicker
					v-model="twitterStore.showAfter"
					:onCleared="twitterStore.updateShowAfter"
					:clearable="false"
					class="w-40"
				/>
			</div>
			...
			<div>
				...
				<div class="my-2" />
				<VueDatePicker
					v-model="twitterStore.showBefore"
					:onCleared="twitterStore.updateShowBefore"
					:clearable="false"
					class="w-40"
				/>
			</div>
			...
			<div
				:class="
					getButtonStyle(
						!!twitterStore.tweetUserMentionsSearch.length
					)
				"
			...
			<div class="flex flex-row items-center">
				...
				<template v-if="twitterStore.filterTweetsByUserActions">
					...
					<div
						...
						@click="
							twitterStore.toggleFilterTweetsByUserActionsGreater
						"
					>
						{{
